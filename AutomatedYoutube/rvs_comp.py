...
def AutomatedRVS():
    ...
    finalvideopath = "C:\\Users\\john\\PycharmProjects\\Automated Test\\.finishedvideo\\comp.mp4"
    for link in urlList:
    ...
    for file in os.listdir(path):
        ...
        pathList.append(vc)
    print(pathList)
    final_video = concatenate_videoclips(pathList, method="compose")
    final_video.write_videofile(finalvideopath, fps=60, codec="libx264")
