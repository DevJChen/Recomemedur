...
def AutomatedRVS():
    ...
    page = requests.get("https://www.reddit.com/r/Unexpected/top/.json", headers={'User-agent': '29572913808'}).json()
    ...
    while count < page_dist:
        if ((page_data[count]["data"]["is_video"] == True) and (
            ...
            tags = title.split()
            other_tags = "#shorts,best of tiktok,funny moments,funny video,funny videos,funny videos 2021,new funny comedy video,short,shorts,shorts video youtube,shorts youtube,tiktok,tiktok 2021,tiktok compilation,tiktok dances 2021,tiktok mashup,tiktok meme,tiktok memes,viral shorts,youtube short,youtube shorts,youtube shorts 2021,youtube shorts video,youtube vs tiktok,yt shorts"
